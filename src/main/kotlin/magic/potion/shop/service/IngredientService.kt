...
class IngredientService(
    ...
    fun createIngredient(ingredient: Ingredient?): Ingredient {
        ...
        val withSelfRel = WebMvcLinkBuilder.linkTo(IngredientController::class.java).slash(createdIngredient.id).withSelfRel()
    ...
    fun updateIngredient(id: Long, ingredient: Ingredient): Ingredient {
        ...
        val withSelfRel = WebMvcLinkBuilder.linkTo(IngredientController::class.java).slash(ingredientThatWillBeUpdated.id).withSelfRel()
